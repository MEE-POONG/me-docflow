...
# 2. http://localhost:3000/documents/create การจะสร้างเอกสารได้ ต้องเลือก หมวดหมู่และประเภทเอกสารก่อนเป็น step แรก แล้วถึงจะสร้างเอกสารได้ step2 ให้กรอกข้อมูลก่อนแล้วจึงบันทึก step3ดูข้อมูลเป็นตัวอย่างโดยเลือก doc-format
